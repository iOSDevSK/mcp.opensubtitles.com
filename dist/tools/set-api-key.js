...
import { getSessionApiKey, getSessionLabel, getSessionToken, maskSecret, setSessionApiKey, setSessionToken, clearSessionCredentials, } from "../runtime.js";
...
export async function setApiKey(args) {
    ...
    if (username && password) {
        ...
        try {
            ...
            throw new Error(`OpenSubtitles rejected those credentials for ${username}. ` +
    ...
    try {
        ...
        throw new Error(`The API rejected that key: ${error instanceof Error ? error.message : "unknown error"}`);
    }
    return text([
